...
def run_scraper_job(portal_name: str, scraper_class, brand: str = "BMW", model: str = "Serie 3"):
    db = SessionLocal()
    ...
    try:
        ...
        print(f"[{datetime.now()}] {portal_name} scraper finished. Items: {len(ads)}")
...
# 2. Scraper emiratesauction every 24 hours
